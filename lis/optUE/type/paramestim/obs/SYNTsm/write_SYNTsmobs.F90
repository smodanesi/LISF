...
!BOP
! !ROUTINE: write_SYNTsmobs
! \label{write_SYNTsmobs}
!
! !REVISION HISTORY:
!  25 May 2023: Sara Modanesi; Initial Specification
!
! !INTERFACE: 
subroutine write_SYNTsmobs(Obj_Space)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
! !DESCRIPTION:
!  
!  write the synthetic soil moisture data to disk
!  
!  The arguments are: 
!  \begin{description}
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call SYNTsm_obsname('LISPEOBS',obsname)
...
end subroutine write_SYNTsmobs

!BOP
! 
! !ROUTINE: SYNTsm_obsname
! \label{SYNTsm_obsname}
! 
! !INTERFACE: 
subroutine SYNTsm_obsname(variabname, obsname)
! !USES: 
...
!  Synthetc soil moisture observations. 
! 
!EOP
