...
MODULE module_sf_noahlsm_36
  USE module_model_constants_36, only : CP, R_D, XLF, XLV, RHOWATER, STBOLT, KARMAN
...
! LSM IRRIGATION PARAMETERS: SM27092022

        REAL ::  IRRTHRESH_DATA !SM
...
END MODULE module_sf_noahlsm_36
