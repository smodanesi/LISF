...
!BOP
! !ROUTINE: NoahMP36_getpeobspred_SYNTlaiobs
!  \label{NoahMP36_getpeobspred_SYNTlaiobs}
!
! !REVISION HISTORY:
! 21 Jun 2023: Sara Modanesi; Initial Specification modified based on the SMAPsm dir
!
! !INTERFACE:
subroutine NoahMP36_getpeobspred_SYNTlaiobs(Obj_Func)
! !USES:
  use ESMF
...
!EOP
  ...
  call ESMF_StateGet(Obj_Func,"SYNT_lai",laiField,rc=status)
...
end subroutine NoahMP36_getpeobspred_SYNTlaiobs
